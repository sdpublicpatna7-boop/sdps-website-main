...
DEFAULT_AUDIO_IP = os.getenv("AUDIO_CONTROLLER_IP", "192.168.1.100")
DIRECT_ROUTER_URL = os.getenv("DIRECT_ROUTER_URL", "http://boardcasting.sdpublic.org")
...
async def get_audio_status(
    ...
    ips_to_try = [
        "http://boardcasting.sdpublic.org",
        "192.168.0.101",
        "192.168.1.101",
        "192.168.1.100",
        "192.168.0.100"
