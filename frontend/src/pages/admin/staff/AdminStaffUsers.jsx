  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-4">
          ...
          <p className="text-xs text-emerald-600">
            Limited access — can only manage <strong>Exam Papers</strong> and{" "}
            <strong>Holiday Homework</strong>. Cannot access admissions, settings, payments, or
            other sections.
          </p>
        </div>
      </div>
      ...
      {open && (
        ...
        >
          <form onSubmit={submit} className="bg-white rounded-2xl max-w-md w-full shadow-2xl">
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                >
                  <option value="staff">Staff (Exam Papers + Holiday Homework only)</option>
