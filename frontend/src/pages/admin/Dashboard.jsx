  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-slate-900 via-slate-800 to-brand-blue-dark p-6 md:p-8 rounded-3xl text-white shadow-xl shadow-slate-900/10 relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0 relative z-10 self-start md:self-center">
          <div className="flex items-center gap-2 bg-white/[0.07] backdrop-blur-md border border-white/10 px-3.5 py-2.5 rounded-2xl">
          ...
          <div className="flex items-center gap-1.5 bg-emerald-500/15 backdrop-blur-md border border-emerald-500/30 px-3.5 py-2.5 rounded-2xl">
            <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-300">Version</span>
            <span className="font-mono text-xs font-black text-emerald-400">{appVersion}</span>
          </div>
        </div>
      </div>
