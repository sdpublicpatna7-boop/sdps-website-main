    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider block pl-2 flex items-center gap-1">
          ...
          >
            ...
            <div className="text-center space-y-1">
              ...
              <div className="inline-block px-4 py-1 border border-slate-900 font-bold text-sm tracking-widest bg-slate-50 uppercase rounded">
                SALARY SLIP
              </div>
