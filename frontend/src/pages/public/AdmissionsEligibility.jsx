      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-5">
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5">
            ...
            <p className="text-sm text-amber-700">The minimum age limit to appear for the Class 10th board exam is <strong>14 years</strong>, which means the candidate must have completed 14 years of age as on <strong>31st December</strong> of the year of examination.</p>
